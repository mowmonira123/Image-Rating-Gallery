		...
		<a href="<?php echo base_url ?>?page=albums/images&id=<?php echo $row['id'] ?>" class="album-item">
			...
			<div class="w-100 d-flex justify-content-between">
				...
				<div  class="dropleft">
					...
					<div class="dropdown-menu" aria-labelledby="dropdownMenuLink"><a class="dropdown-item animation" data-id="<?php echo $row['id'] ?>">Animation</a> 
					<?php
					if($_settings->userdata('id') == '1')
					{
	                ?>
						...
						<div class="dropdown-divider data-id="<?php echo $row['id'] ?>></div>
